// flow-typed signature: 14b3003b24191e837157e48da6d202d8
// flow-typed version: db6a808193/react-apollo_v2.x.x/flow_>=v0.58.x
...
declare module 'react-apollo' {
  ...
  declare class ObservableQuery<T> extends Observable<ApolloQueryResult<T>> {
    ...
    updateQuery(mapFn: (previousQueryResult: any, options: UpdateQueryOptions) => mixed): void;
    stopPolling(): void;
  ...
  declare class MutationStore {
    ...
    initMutation(mutationId: string, mutationString: string, variables: Object | void): void;
  }
  ...
  declare export interface WatchQueryOptions extends ModifiableWatchQueryOptions {
    query: DocumentNode;
    metadata?: any;
    context?: any;
  }
  ...
  declare export type QueryListener = (queryStoreValue: QueryStoreValue, newData?: any) => mixed;
  ...
  declare export type ChildProps<TOwnProps, TResult, TVariables: Object = {}> = {
  ...
  declare export type RefetchQueriesProviderFn = (...args: any[]) => string[] | PureQueryOptions[];
  ...
  declare export interface GraphqlQueryControls<TGraphQLVariables = OperationVariables> {
  ...
  declare export function walkTree(
    element: React$Node,
    context: Context,
    visitor: (element: React$Node, instance: any, context: Context) => boolean | void,
  ): void;
  ...
  declare export type QueryRenderProps<TData = any, TVariables = OperationVariables> = {
    ...
    fetchMore: ((
      options: FetchMoreOptions<TData, TVariables> & FetchMoreQueryOptions<TVariables>,
  ...
  declare type SubscriptionProps<TData, TVariables = OperationVariables> = {
    ...
    shouldResubscribe?:
      | boolean
      | ((SubscriptionProps<TData, TVariables>, SubscriptionProps<TData, TVariables>) => boolean),
